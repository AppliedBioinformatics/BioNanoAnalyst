...
PyQt4 or PySide (https://www.riverbankcomputing.com/software/pyqt/download. or $pip install PySide. Please refer Issue #1 or create new  Issues if you cannot install PyQt4 in your system) 
